...
public abstract class XenonCommand implements ICommand {
    ...
    protected Credential buildCredential(Namespace res) throws XenonException {
        return buildCredential(res,  "");
    }

    protected Credential buildCredential(Namespace res, String prefix)  throws XenonException {
